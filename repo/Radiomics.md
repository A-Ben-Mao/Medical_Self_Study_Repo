...
同时该up主该系列还有3DSlicer的补充操作教学（质量可），以及影像组学pyradiomics的操作教学（未观看，不知质量，但基于已经看过的该up主视频而言，推知应该OK）。
...
2.2 在Windows环境下使用Matlab的SPM进行配准与标准化
...
2.3 在Linux环境下使用ANTS进行配准与标准化

【【核磁共振影像数据处理】高级的配准软件ANTS使用介绍】 https://www.bilibili.com/video/BV1hB4y1K7gf/?share_source=copy_web&vd_source=b95542217fcd022ca9ecd4f03e450342

但只是参考官方手册演示了一下，无太多具体参数内容（暂定，似乎不是最佳教程）

---
3.通过3DSlicer进行颅骨剥离/头皮剔除

3.1 使用插件SwissSkullStripper进行自动剥离
...
【3D Slicer共学 | CT和MRI去脑壳】 https://www.bilibili.com/video/BV1KG4y1Y7N9/?share_source=copy_web&vd_source=b95542217fcd022ca9ecd4f03e450342

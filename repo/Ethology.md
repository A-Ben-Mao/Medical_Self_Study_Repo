...
- 这个**实验内容很简单**，注意前期动物的环境适应和选择同一时间段测量，主要工作量在测量后软件的分析。
...
## 2.4 社交回避测试（Social Defeat / Social Interaction Test）
